...
async function getUpdates(limit: number): Promise<BlogPostPreview[]> {
  try {
    return await client.fetch<BlogPostPreview[]>(
...
export default async function SynergyUpdatesServer({ limit = 8 }: { limit?: number }) {
