              ...
              <div className="flex-1 space-y-4">
                  ...
                  <div className="space-y-4">
                    ...
                    >
                      <div className="space-y-4">
                        ...
                        <p className="text-gray-300 leading-relaxed">
                          Rossi sees every day as an opportunity to fail and try
                          again, searching not for favor or gratuity but for the
                          wisdom that comes from personal growth and trials. His
                          philosophy is not to be special or different but to be
                          aware of himself and his vanity—to feel the sour
                          flavor of the human experience and cherish it for the
                          sweet bitter feeling that comes with the struggles of
                          everyday life.
                        </p>
                        <div className="grid grid-cols-1 md:grid-cols-2 gap-4 mt-4">
                          <div className="bg-white/5 rounded-lg p-4">
                            <h3 className="text-[#e68531] font-medium mb-2">
                              Academic & Artistic Path
                            </h3>
                            <ul className="list-disc list-inside text-sm text-gray-300 space-y-1">
                              <li>
                                Undergraduate of Biomedicine at Cyprus
                                International University
                              </li>
                              <li>
                                Early passion for literature and spoken word
                              </li>
                              <li>Developed interest in melody production</li>
                              <li>
                                Balances scientific studies with artistic
                                pursuits
                              </li>
                            </ul>
                          </div>
                          ...
                          <div className="bg-white/5 rounded-lg p-4">
                            ...
                            <ul className="list-disc list-inside text-sm text-gray-300 space-y-1">
                              <li>Embraces failure as a path to growth</li>
                              <li>Seeks wisdom through personal trials</li>
                              <li>Values authenticity over specialness</li>
                              <li>Explores the duality of human experience</li>
                              <li>Finds beauty in life's struggles</li>
                            </ul>
                          </div>
                        </div>
                      </div>
                ...
                <div className="grid grid-cols-2 md:grid-cols-3 gap-4">
                  <div className="bg-white/5 rounded-lg p-3">
                    ...
                    <div className="text-sm">Afrobeats, Hip-hop, R&B</div>
                  </div>
                  <div className="bg-white/5 rounded-lg p-3">
                    <div className="text-[#e68531] text-sm font-medium mb-1">
                      Active Since
